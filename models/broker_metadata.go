...
// BrokerMetadata provides compile-time metadata for Broker
var BrokerMetadata = &orm.ModelMetadata{
	TableName:  "brokers",
	StructName: "Broker",
	...
	Columns: map[string]*orm.ColumnMetadata{
		...
		"Description": {
			...
			IsNil: func(model interface{}) bool {
				return model.(Broker).Description == nil
			},
		},
		"IsActive": {
			FieldName:       "IsActive",
	...
	Relationships: map[string]*orm.RelationshipMetadata{
		"Project": {
			...
			SetValue: func(model interface{}, value interface{}) {
				model.(*Broker).Project = value.(*Project)
			},
			IsSlice: false,
		},
		"Pipelines": {
			...
			// Generated accessor functions for relationships
			SetValue: func(model interface{}, value interface{}) {
				model.(*Broker).Pipelines = value.([]Pipeline)
			},
			IsSlice: true,
		},
	},
