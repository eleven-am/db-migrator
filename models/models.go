...
type ApiKey struct {
	_ struct{} `storm:"table:api_keys;index:idx_api_keys_project_id,project_id;unique:api_keys_key_prefix_key,key_prefix"`

	Id          string     `db:"id" storm:"column:id;type:char(25);primary_key;default:gen_cuid()"`
	ProjectId   string     `db:"project_id" storm:"column:project_id;type:char(25);not_null;foreign_key:projects.id"`
	...
	Permissions []string   `db:"permissions" storm:"column:permissions;type:text[];default:'{}'"`
...
type AuditLog struct {
	...
	Id            string    `db:"id" storm:"column:id;type:char(25);primary_key;default:gen_cuid()"`
	TeamId        *string   `db:"team_id" storm:"column:team_id;type:char(25);foreign_key:teams.id"`
	UserId        *string   `db:"user_id" storm:"column:user_id;type:char(25);foreign_key:users.id"`
	...
	ApiKeyId      *string   `db:"api_key_id" storm:"column:api_key_id;type:char(25);foreign_key:api_keys.id"`
...
type AuthCredential struct {
	...
	Id          string     `db:"id" storm:"column:id;type:char(25);primary_key;default:gen_cuid()"`
	ProjectId   string     `db:"project_id" storm:"column:project_id;type:char(25);not_null;foreign_key:projects.id"`
	Type        string     `db:"type" storm:"column:type;type:text;not_null"`
	Name        string     `db:"name" storm:"column:name;type:text;not_null"`
	Headers     string     `db:"headers" storm:"column:headers;type:text;not_null"`
	ExpiresAt   *time.Time `db:"expires_at" storm:"column:expires_at;type:timestamptz"`
...
type Broker struct {
	...
	Config      map[string]interface{} `db:"config" storm:"column:config;type:jsonb;not_null;default:'{}'"`
	CreatedAt   time.Time              `db:"created_at" storm:"column:created_at;type:timestamptz;not_null;default:now()"`
	UpdatedAt   time.Time              `db:"updated_at" storm:"column:updated_at;type:timestamptz;not_null;default:now()"`
	Project     *Project               `storm:"relation:belongs_to:Project;foreign_key:project_id;target_key:id"`
	Pipelines   []Pipeline             `storm:"relation:has_many:Pipeline;foreign_key:dlq_broker_id;source_key:id"`
}
...
type DlqMessage struct {
	...
	PipelineId   string                 `db:"pipeline_id" storm:"column:pipeline_id;type:char(25);not_null;foreign_key:pipelines.id"`
	TriggerId    string                 `db:"trigger_id" storm:"column:trigger_id;type:char(25);not_null;foreign_key:triggers.id"`
	...
	Headers      map[string]interface{} `db:"headers" storm:"column:headers;type:jsonb;not_null;default:'{}'"`
	...
	Metadata     map[string]interface{} `db:"metadata" storm:"column:metadata;type:jsonb;not_null;default:'{}'"`
	CreatedAt    time.Time              `db:"created_at" storm:"column:created_at;type:timestamptz;not_null;default:now()"`
	UpdatedAt    time.Time              `db:"updated_at" storm:"column:updated_at;type:timestamptz;not_null;default:now()"`
...
type ExecutionLog struct {
	...
	InputData     map[string]interface{} `db:"input_data" storm:"column:input_data;type:jsonb;not_null;default:'{}'"`
	OutputData    map[string]interface{} `db:"output_data" storm:"column:output_data;type:jsonb;not_null;default:'{}'"`
	ErrorDetails  map[string]interface{} `db:"error_details" storm:"column:error_details;type:jsonb;not_null;default:'{}'"`
	Metadata      map[string]interface{} `db:"metadata" storm:"column:metadata;type:jsonb;not_null;default:'{}'"`
	CreatedAt     time.Time              `db:"created_at" storm:"column:created_at;type:timestamptz;not_null;default:now()"`
	EventSummary  map[string]interface{} `db:"event_summary" storm:"column:event_summary;type:jsonb;not_null;default:'{}'"`
	StageEvents   map[string]interface{} `db:"stage_events" storm:"column:stage_events;type:jsonb;not_null;default:'{}'"`
	TotalEvents   int32                  `db:"total_events" storm:"column:total_events;type:integer;not_null;default:0"`
	Pipeline      *Pipeline              `storm:"relation:belongs_to:Pipeline;foreign_key:pipeline_id;target_key:id"`
	Project       *Project               `storm:"relation:belongs_to:Project;foreign_key:project_id;target_key:id"`
	Trigger       *Trigger               `storm:"relation:belongs_to:Trigger;foreign_key:trigger_id;target_key:id"`
}
...
type OauthToken struct {
	...
	Scopes          []string                `db:"scopes" storm:"column:scopes;type:text[];default:'{}'"`
	Email           *string                 `db:"email" storm:"column:email;type:text"`
	Metadata        *map[string]interface{} `db:"metadata" storm:"column:metadata;type:jsonb;default:'{}'"`
	Config          *map[string]interface{} `db:"config" storm:"column:config;type:jsonb;default:'{}'"`
	CreatedAt       time.Time               `db:"created_at" storm:"column:created_at;type:timestamptz;not_null;default:now()"`
	UpdatedAt       time.Time               `db:"updated_at" storm:"column:updated_at;type:timestamptz;not_null;default:now()"`
	Project         *Project                `storm:"relation:belongs_to:Project;foreign_key:project_id;target_key:id"`
}
...
type PipelineEvent struct {
	...
	InputData        map[string]interface{}  `db:"input_data" storm:"column:input_data;type:jsonb;not_null;default:'{}'"`
	OutputData       map[string]interface{}  `db:"output_data" storm:"column:output_data;type:jsonb;not_null;default:'{}'"`
	ErrorDetails     *map[string]interface{} `db:"error_details" storm:"column:error_details;type:jsonb"`
	Metadata         map[string]interface{}  `db:"metadata" storm:"column:metadata;type:jsonb;not_null;default:'{}'"`
	ProjectId        string                  `db:"project_id" storm:"column:project_id;type:char(25);not_null;foreign_key:projects.id"`
	PipelineId       string                  `db:"pipeline_id" storm:"column:pipeline_id;type:char(25);not_null;foreign_key:pipelines.id"`
...
type Pipeline struct {
	_ struct{} `storm:"table:pipelines;index:idx_pipelines_active,is_active where:(is_active = true);index:idx_pipelines_project_id,project_id;unique:uk_pipelines_project_name_version,project_id,name,version;unique:uk_pipelines_project_name_version,project_id,name,version"`

	Id             string                 `db:"id" storm:"column:id;type:char(25);primary_key;default:gen_cuid()"`
	ProjectId      string                 `db:"project_id" storm:"column:project_id;type:char(25);not_null;foreign_key:projects.id"`
	Name           string                 `db:"name" storm:"column:name;type:varchar(255);not_null"`
	Description    string                 `db:"description" storm:"column:description;type:text;not_null;default:''"`
	Version        string                 `db:"version" storm:"column:version;type:varchar(50);not_null;default:1.0.0"`
	IsActive       bool                   `db:"is_active" storm:"column:is_active;type:boolean;not_null;default:true"`
	DlqBrokerId    *string                `db:"dlq_broker_id" storm:"column:dlq_broker_id;type:char(25);foreign_key:brokers.id"`
	Metadata       map[string]interface{} `db:"metadata" storm:"column:metadata;type:jsonb;not_null;default:'{}'"`
	Config         map[string]interface{} `db:"config" storm:"column:config;type:jsonb;not_null;default:'{}'"`
	CreatedAt      time.Time              `db:"created_at" storm:"column:created_at;type:timestamptz;not_null;default:now()"`
	UpdatedAt      time.Time              `db:"updated_at" storm:"column:updated_at;type:timestamptz;not_null;default:now()"`
	DlqBroker      *Broker                `storm:"relation:belongs_to:Broker;foreign_key:dlq_broker_id;target_key:id"`
	Project        *Project               `storm:"relation:belongs_to:Project;foreign_key:project_id;target_key:id"`
...
type Project struct {
	...
	Id              string           `db:"id" storm:"column:id;type:char(25);primary_key;default:gen_cuid()"`
	TeamId          string           `db:"team_id" storm:"column:team_id;type:char(25);not_null;foreign_key:teams.id"`
	Name            string           `db:"name" storm:"column:name;type:text;not_null"`
	CreatedAt       time.Time        `db:"created_at" storm:"column:created_at;type:timestamptz;not_null;default:now()"`
	UpdatedAt       time.Time        `db:"updated_at" storm:"column:updated_at;type:timestamptz;not_null;default:now()"`
	Team            *Team            `storm:"relation:belongs_to:Team;foreign_key:team_id;target_key:id"`
...
type Stage struct {
	_ struct{} `storm:"table:stages;index:idx_stages_pipeline_id,pipeline_id;index:idx_stages_stage_id,stage_id;unique:uk_stages_pipeline_stage,pipeline_id,stage_id;unique:uk_stages_pipeline_stage,pipeline_id,stage_id"`

	Id          string                 `db:"id" storm:"column:id;type:char(25);primary_key;default:gen_cuid()"`
	PipelineId  string                 `db:"pipeline_id" storm:"column:pipeline_id;type:char(25);not_null;foreign_key:pipelines.id"`
	StageId     string                 `db:"stage_id" storm:"column:stage_id;type:varchar(100);not_null"`
	Type        string                 `db:"type" storm:"column:type;type:varchar(50);not_null"`
	Action      map[string]interface{} `db:"action" storm:"column:action;type:jsonb;not_null;default:'{}'"`
	Target      map[string]interface{} `db:"target" storm:"column:target;type:jsonb;not_null;default:'{}'"`
	DependsOn   []string               `db:"depends_on" storm:"column:depends_on;type:text[];not_null;default:'{}'"`
	Filter      *string                `db:"filter" storm:"column:filter;type:text"`
	Timeout     *time.Duration         `db:"timeout" storm:"column:timeout;type:interval"`
	CacheConfig map[string]interface{} `db:"cache_config" storm:"column:cache_config;type:jsonb;not_null;default:'{}'"`
	CreatedAt   time.Time              `db:"created_at" storm:"column:created_at;type:timestamptz;not_null;default:now()"`
	UpdatedAt   time.Time              `db:"updated_at" storm:"column:updated_at;type:timestamptz;not_null;default:now()"`
	Pipeline    *Pipeline              `storm:"relation:belongs_to:Pipeline;foreign_key:pipeline_id;target_key:id"`
}

// StatusCount represents the status_counts table
type StatusCount struct {
	Count  *int32  `db:"count" storm:"column:count;type:integer"`
	Status *string `db:"status" storm:"column:status;type:text"`
}
...
type Subscription struct {
	...
	Id        string    `db:"id" storm:"column:id;type:char(25);primary_key;default:gen_cuid()"`
	PlanId    string    `db:"plan_id" storm:"column:plan_id;type:char(25);not_null;foreign_key:plans.id"`
	TeamId    string    `db:"team_id" storm:"column:team_id;type:char(25);not_null;foreign_key:teams.id"`
...
// TimePoint represents the time_points table
type TimePoint struct {
	Hour  *time.Time `db:"hour" storm:"column:hour;type:timestamptz"`
	Count *int32     `db:"count" storm:"column:count;type:integer"`
}
...
type Trigger struct {
	...
	Id              string                 `db:"id" storm:"column:id;type:char(25);primary_key;default:gen_cuid()"`
	ProjectId       string                 `db:"project_id" storm:"column:project_id;type:char(25);not_null;foreign_key:projects.id"`
	PipelineIds     []string               `db:"pipeline_ids" storm:"column:pipeline_ids;type:text[];not_null;default:'{}'"`
	Name            string                 `db:"name" storm:"column:name;type:varchar(255);not_null"`
	Type            string                 `db:"type" storm:"column:type;type:varchar(50);not_null"`
	EntityId        string                 `db:"entity_id" storm:"column:entity_id;type:varchar(255);not_null;unique"`
	IsActive        bool                   `db:"is_active" storm:"column:is_active;type:boolean;not_null;default:true"`
	Config          map[string]interface{} `db:"config" storm:"column:config;type:jsonb;not_null;default:'{}'"`
	AuthConfig      map[string]interface{} `db:"auth_config" storm:"column:auth_config;type:jsonb;not_null;default:'{}'"`
	LastTriggeredAt *time.Time             `db:"last_triggered_at" storm:"column:last_triggered_at;type:timestamptz"`
	LastError       map[string]interface{} `db:"last_error" storm:"column:last_error;type:jsonb;not_null;default:'{}'"`
...
// TypeCount represents the type_counts table
type TypeCount struct {
	Count     *int32  `db:"count" storm:"column:count;type:integer"`
	EventType *string `db:"event_type" storm:"column:event_type;type:text"`
}
